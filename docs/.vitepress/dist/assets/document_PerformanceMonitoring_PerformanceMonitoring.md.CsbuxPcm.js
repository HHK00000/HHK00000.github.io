import{_ as a,c as s,o as e,ae as i}from"./chunks/framework.Dh1jimFm.js";const u=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"document/PerformanceMonitoring/PerformanceMonitoring.md","filePath":"document/PerformanceMonitoring/PerformanceMonitoring.md"}'),p={name:"document/PerformanceMonitoring/PerformanceMonitoring.md"};function l(t,n,o,c,r,d){return e(),s("div",null,n[0]||(n[0]=[i(`<h2 id="埋点和性能监控" tabindex="-1">埋点和性能监控 <a class="header-anchor" href="#埋点和性能监控" aria-label="Permalink to &quot;埋点和性能监控&quot;">​</a></h2><h3 id="埋点" tabindex="-1">埋点 <a class="header-anchor" href="#埋点" aria-label="Permalink to &quot;埋点&quot;">​</a></h3><ul><li>埋点：埋点分析，是网站分析的一种常用的数据采集方法</li><li>埋点的目的：获取用户信息，根据用户喜好，定制不同内容、决定产品迭代方向等</li></ul><h3 id="性能监控" tabindex="-1">性能监控 <a class="header-anchor" href="#性能监控" aria-label="Permalink to &quot;性能监控&quot;">​</a></h3><ul><li>性能监控主要注意的几点： <ul><li>白屏时长（从请求到到达渲染条件，出现ui骨架的时间）</li><li>重要页面的http请求时间</li><li>重要页面的渲染时间</li><li>首屏加载时长（页面所有动态内容加载完成的时间，包括ajax数据后渲染到页面的时间）</li></ul></li><li>数据监控就是能拿到用户的行为，需要注意的几点： <ul><li>PV访问量（Page View）</li><li>UV访问量（Unique Visitor）</li><li>记录操作系统和浏览器</li><li>记录用户在页面的停留时间</li><li>进入当前页面的来源页面（from 也就是哪里来的转化）</li></ul></li></ul><h3 id="几种埋点方式" tabindex="-1">几种埋点方式 <a class="header-anchor" href="#几种埋点方式" aria-label="Permalink to &quot;几种埋点方式&quot;">​</a></h3><h4 id="手动埋点-代码埋点" tabindex="-1">手动埋点（代码埋点） <a class="header-anchor" href="#手动埋点-代码埋点" aria-label="Permalink to &quot;手动埋点（代码埋点）&quot;">​</a></h4><ul><li>域名 document.domainURL document.URL</li><li>页面标题 document.title</li><li>分辨率 window.screen.height &amp; window.screen.width</li><li>颜色深度 window.screen.colorDepth</li><li>Referrer document.referrer</li><li>客户端语言 navigation.language</li><li>Performance:DNS解析时间、TCP建立连接时间、首屏白屏时间、DOM渲染完成时间、页面load时间等<div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>  //拿到Performance并且初始化一些参数</span></span>
...
<span class="line"><span>    })()</span></span>
<span class="line"><span>  &lt;/script&gt;</span></span></code></pre></div></li><li>上图一段代码插入我们的html中,便能清晰的看到统计数据，省时省力，就是不省钱！但是缺点就是由于是自动完成，无法针对特定场景拿到数据，由后端来过滤和计算出有用的数据。导致服务器压力山大</li></ul>`,12)]))}const h=a(p,[["render",l]]);export{u as __pageData,h as default};
